...
class TestNatsInstrumentorLifecycle:
    ...
    def test_instrument_patches_jetstream(self, tracer_provider):
        ...
        ) or isinstance(nats.js.client.JetStreamContext.publish, wrapt.FunctionWrapper)
    ...
    def test_uninstrument_restores_methods(self, tracer_provider):
        ...
        assert not isinstance(nats.aio.client.Client.publish, wrapt.FunctionWrapper)
        assert not isinstance(nats.aio.client.Client.subscribe, wrapt.FunctionWrapper)
        assert not isinstance(nats.aio.client.Client.request, wrapt.FunctionWrapper)
